...
def get(cfg_file="tevs.cfg"):
    ...
    mwi = config.get("Sizes", "target_width_inches")
    mhi = config.get("Sizes", "target_height_inches")
    ...
    const.target_width_inches = float(mwi)
    const.target_height_inches = float(mhi)
